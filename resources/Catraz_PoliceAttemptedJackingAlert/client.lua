local notificationText = "Police Dispatch: Pedestrian Seen Attempting To Break Into A Vehicle - Respond Code Three"
...
Citizen.CreateThread( function()
	while true do
		...
		if not CheckPolice(ped) then
			local pedShooting = IsPedTryingToEnterALockedVehicle(ped)
