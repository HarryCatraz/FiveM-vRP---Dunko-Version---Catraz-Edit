...
local chanceForSpread = 500 -- basically a thousand sided dice is rolled and if it gets above this number then the fire spreads once
...
local randomSpawnTime = 1800000 -- time to wait before trying ot spawn another random fire in milliseconds 1,200,000 is 20 minutes this is per player.
local randomFireLocations = { --  this is the format you need to put in for your possible locations.
    ...
    { ['x'] = 1000, ['y'] = 1000, ['z'] = 0 },
    { ['x'] = 2490.0000, ['y'] = 3777, ['z'] = 0 },
    { ['x'] = 111.94303222126677, ['y'] = 2937.9776235901777, ['z'] = 0 },
    { ['x'] = 39.08751377466501, ['y'] = 3529.7491288166584, ['z'] = 0 },
    { ['x'] = 485.3275642601018, ['y'] = 3538.853305820143, ['z'] = 0 },
    { ['x'] = 436.7572186290338, ['y'] = 622.4819390373318, ['z'] = 0 }, -- West Of RaceTrck
