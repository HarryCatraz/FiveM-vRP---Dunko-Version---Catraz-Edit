...
Citizen.CreateThread(function()
	while true do
			...
			for i = 0,32 do
				if(GetPlayerName(i))then
					if(NetworkIsPlayerTalking(i))then
						...
						if(t == 1)then
								drawTxt(0.515, 0.95, 1.0,1.0,0.4, "~y~Speaking", 255, 255, 255, 255)
						end
		...
		if(IsPedInAnyVehicle(GetPlayerPed(-1), false))then
			...
			drawTxt(1.41, 0.97, 1.0,1.0,0.7, "~y~" .. math.ceil(speed) .. "", 255, 255, 255, 255)
			drawTxt(1.4, 1.03, 1.0,1.0,0.7, "~b~ MPH", 255, 255, 255, 255)
		end
	end
end)