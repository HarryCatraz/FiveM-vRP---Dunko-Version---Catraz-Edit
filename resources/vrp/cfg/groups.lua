...
cfg.groups = {
  ["superadmin"] = {
    _config = {onspawn = function(player) vRPclient.notify(player,{"You Are Now A Super Admin"}) end},
    "player.group.add",
    "player.group.remove",
    "player.givemoney",
    "player.giveitem"
  ...
  ["Metropolitan Police"] = {
    ...
    "Officer.cloakroom", -- Metropolitan Police 
  ...
  ["Criminal Investigation Department"] = {  
	...
	"Detective.cloakroom", -- Criminal Investigation Department 
...
--},
  ...
  ["Cadet"] = {
	...
	"police.cloakroom", -- Metropolitan Police
  ...
  ["Bounty Hunter"] = {
	...
	"Bounty.cloakroom", -- Bounty Hunter
  ...
  ["Sheriffs Office"] = {
	...
	"sheriff.cloakroom", -- Sheriff Office
  ...
  ["State Police"] = {
	...
	"Commander.cloakroom", -- State Police
	...
	"Captain.cloakroom", -- Department Command
	...
	"Lieutenant.cloakroom", -- Internal Affairs
	...
	"Sergeant.cloakroom", -- Police Supervisor / 
